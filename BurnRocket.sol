...
*     token features:
* 
*    5% marketing wallet. 2% to dev. 2% to marketing team.
* 
*    5% fee on each tx, distributed to all holders
*    5% fee on each tx, added to the liquidity pool
*    40% of supply is burned at start
*                    Deflationary
*    Telegram: https://t.me/ShibaSlap
* 
* 
*
* 
...
contract ShibaSlap is Context, IERC20, Ownable {
    ...
    string private _name = "Shiba Slap";
